...
export const playersGet = (id: number) => {
	return customInstance<EntitiesPlayer>({ url: `/players/${id}`, method: "GET" });
};
...
export const getPlayersGetQueryOptions = <
	TData = Awaited<ReturnType<typeof playersGet>>,
	TError = ErrorType<InternalErrorResponse>
>(
	id: number,
	options?: {
		query?: Partial<CreateQueryOptions<Awaited<ReturnType<typeof playersGet>>, TError, TData>>;
	}
) => {
	const { query: queryOptions } = options ?? {};
	...
	const queryFn: QueryFunction<Awaited<ReturnType<typeof playersGet>>> = () => playersGet(id);

	return { queryKey, queryFn, enabled: !!id, ...queryOptions } as CreateQueryOptions<
		Awaited<ReturnType<typeof playersGet>>,
		TError,
		TData
	> & { queryKey: DataTag<QueryKey, TData, TError> };
};
...
export function createPlayersGet<
	TData = Awaited<ReturnType<typeof playersGet>>,
	TError = ErrorType<InternalErrorResponse>
>(
	id: number,
	...
	const queryOptions = getPlayersGetQueryOptions(id, options);
