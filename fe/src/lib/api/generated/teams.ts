...
export const createTeamsUpdate = <TError = ErrorType<InternalErrorResponse>, TContext = unknown>(
	options?: {
		mutation?: CreateMutationOptions<
			Awaited<ReturnType<typeof teamsUpdate>>,
			TError,
...
export const createTeamsInsert = <TError = ErrorType<InternalErrorResponse>, TContext = unknown>(
	options?: {
		mutation?: CreateMutationOptions<
			Awaited<ReturnType<typeof teamsInsert>>,
			TError,
...
export const teamsGet = (id: number) => {
	return customInstance<EntitiesTeam>({ url: `/teams/${id}`, method: "GET" });
};
...
>(
	id: number,
	options?: {
		query?: Partial<CreateQueryOptions<Awaited<ReturnType<typeof teamsGet>>, TError, TData>>;
	}
) => {
	const { query: queryOptions } = options ?? {};
	...
	const queryFn: QueryFunction<Awaited<ReturnType<typeof teamsGet>>> = () => teamsGet(id);
...
export function createTeamsGet<
	TData = Awaited<ReturnType<typeof teamsGet>>,
	TError = ErrorType<InternalErrorResponse>
>(
	id: number,
	...
	const queryOptions = getTeamsGetQueryOptions(id, options);
...
export const createTeamsDelete = <TError = ErrorType<InternalErrorResponse>, TContext = unknown>(
	options?: {
		mutation?: CreateMutationOptions<
			Awaited<ReturnType<typeof teamsDelete>>,
			TError,
