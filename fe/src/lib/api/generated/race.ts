...
export const createRaceUpdate = <TError = ErrorType<InternalErrorResponse>, TContext = unknown>(
	options?: {
		mutation?: CreateMutationOptions<
			Awaited<ReturnType<typeof raceUpdate>>,
			TError,
...
export const createRaceInsert = <TError = ErrorType<InternalErrorResponse>, TContext = unknown>(
	options?: {
		mutation?: CreateMutationOptions<
			Awaited<ReturnType<typeof raceInsert>>,
			TError,
...
export const createRaceStop = <TError = ErrorType<InternalErrorResponse>, TContext = unknown>(
	options?: {
		mutation?: CreateMutationOptions<
			Awaited<ReturnType<typeof raceStop>>,
			TError,
...
export const createRaceStart = <TError = ErrorType<InternalErrorResponse>, TContext = unknown>(
	options?: {
		mutation?: CreateMutationOptions<
			Awaited<ReturnType<typeof raceStart>>,
			TError,
...
export const raceDelete = (id: number) => {
	return customInstance<null>({ url: `/race/${id}`, method: "DELETE" });
};
...
export const createRaceDelete = <TError = ErrorType<InternalErrorResponse>, TContext = unknown>(
	options?: {
		mutation?: CreateMutationOptions<
			Awaited<ReturnType<typeof raceDelete>>,
			TError,
